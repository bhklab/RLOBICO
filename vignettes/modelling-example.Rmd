...
models algorithms. In the field of cancer biomarker discovery, where models 
...
generation of hypotheses. Logical models satisfies the urgent need for 
approaches that builds small, interpretable, yet accurate models which capture 
